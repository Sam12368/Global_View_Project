...
export default function WorldMap() {
  ...
  const {
    ...
    addLatitude,
    highlightedCellIds,  // cellules en surbrillance (depuis histogram)
  } = useSelections();
  ...
  const drawOverlay = useCallback(() => {
    ...
    // rectangle en cours de dessin (drag) - seulement en mode areas
    if (mode === "areas" && dragStart && dragCurrent) {
